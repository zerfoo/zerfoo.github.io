export const CORE_REVISION='bfbb7071';
export function filesFor(project) {
  ...
  return {
    ...
    'model.recipe.json':json({recipe:project.recipe,definition_generated_after_dataset_inspection:true,layers:[{operator:'Dense',width:16},{operator:'ReLU'},{operator:'Dense',width:'observed_class_count'}],runtime:'cpu/float32',trained:false}),
